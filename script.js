// ==========================================
// 1. CONFIGURATION ZONE (EASY TO MODIFY)
// ==========================================
const ADMIN_CONFIG = {
  ...
  practiceQuestions: [
    ...
    },
    {
      ...
      options: [
        ...
        "Mengadili kasus pinda luar biasa."
      ],
      answer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        "Bekerja seadanya dan membiarkan rekan lain menyelesaikan.",
  ...
  tryoutQuestions: [
    ...
    },
    {
      id: 6,
      category: "Tes Wawasan Kebangsaan (TWK)",
      question: "Pada masa orde lama, kekuasaan presiden sangat besar sehingga Pancasila dan Undang-Undang Dasar 1945 tidak dapat berjalan dengan semestinya. Hal berikut yang merupakan penyimpangan Pancasila pada masa demokrasi terpimpin adalah...",
      options: [
        "Penyelewengan jalannya pemilu berkala",
        "Adanya pengekangan terhadap hak asasi dan kebebasan demokrasi",
    ...
    },
    {
      ...
      answer: 0,
      explanation: "Pulau Dana (di selatan Nusa Tenggara Timur) berbatasan langsung dengan perairan teritorial benua Australia."
        },
    {
      id: 16,
      category: "Tes Wawasan Kebangsaan (TWK)",
    ...
    },
    {
      ...
      options: [
        ...
        "Sistem ketatanegaraan yang bertumpu mutlak pada MPR sebagai pemegang kedaulatan rakyat tertinggi.",
    ...
    },
    {
      ...
      answer: 1,
      explanation: "Terdapat pola tiga urutan bilangan: Suku ke-1, 4, 7 bertambah (+2). Suku ke-2, 5, 8 bertambah (+2). Maka angka selanjutnya adalah 10 dan 11."
    },
    {
      id: 49,
      category: "Tes Inteligensia Umum (TIU)",
    ...
    },
    {
      id: 58,
      category: "Tes Inteligensia Umum (TIU)",
      question: "Dani menabung di koperasi. Bulan ke-1 sebesar Rp 10.000, bulan berikutnya selalu bertambah Rp 5.000 lebih besar dari bulan sebelumnya. Jumlah tabungan Dani selama 1 tahun (12 bulan) adalah...",
      options: [
        "Rp. 400.000",
        "Rp. 450.000",
        "Rp. 500.000",
    ...
    },
    {
      ...
      options: [
        "Tetap aktif di media sosial and membentengi diri agar terhindar dari paham radikalisme.",
    ...
    },
    {
      ...
      options: [
        ...
        "Meminta rekan sejawat menggantikan posisi Anda secara penuh hari ini.",
    ...
    },
    {
      ...
      question: "Saat tertawa terpingkal-pingkal melihat foto konyol di MRT, Anda dipandangi penumpang lain dengan tatapan heran. Tindakan Anda...",
      options: [
    ...
    },
    {
      ...
      answer: 2,
      explanation: "Menjaga kerukunan antar-tetangga dan mengutamakan silaturahmi warga di atas sentimen pribadi menunjukkan kematangan bermasyarakat."
    },
    {
      id: 98,
      category: "Tes Karakteristik Pribadi (TKP) - Sosial Budaya",
      ...
      answer: 4,
      explanation: "Menangani konflik bertetangga secara damai dan normatif lewat mediasi ketua RT adalah langkah sosial terbaik yang tidak merusak hubungan."
    },
    {
      id: 99,
      category: "Tes Karakteristik Pribadi (TKP) - Sosial Budaya",
...
function startPracticeQuiz() {
  ...
  quizTimer = setInterval(() => {
    ...
    document.getElementById('quiz-timer-display').innerText = `${mins.toString().padStart(2, '0')}:${secs.toString().padStart(2, '0')}`;
  ...
  quizQuestions.forEach((q, idx) => {
    ...
    expDiv.innerHTML = `
      ...
      <div class="bg-stone-900 p-3.5 rounded-xl border border-stone-800 text-xs text-stone-300">
        ...
        <span class="block text-stone-400 mt-2">